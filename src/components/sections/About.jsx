...
function About() {
    ...
    const frontendSkills =
       ["React", "TypeScript", "TailwindCSS", "BootStrap", "Javascript"];
    

    const backendSkills = 
      [ "Nodejs", "AWS", "Mongodb", "Php", "Java", "C"]
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
                    <div className="p-6 rounded-xl border-white/10 border hover:-translate-y-1 transition-all">
                        ...
                        <ul className='list-disc list-inside text-gray-300 space-y-2'>
                            <li>
                                <strong> B.E. in Information & Technology</strong> - Gujarat Technological University (GTU)
                                (2022-2026) 
                            </li>
                            <li>
                                    Relevent CourseWork: Cyber Security, Full Stack WebDevlopment,
